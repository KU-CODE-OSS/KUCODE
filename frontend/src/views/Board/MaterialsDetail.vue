<template>
  <div class="materials-detail-page">
    <div class="detail-container">
      ...
      <aside class="sidebar-navigation">
        <button
          ...
          :class="{ active: category.value === 'learning' }"
          @click="navigateToCategory(category.value)"
        >
          <span>{{ category.label }}</span>
          <svg v-if="category.value === 'learning'" width="12" height="8" viewBox="0 0 12 8" fill="none" class="arrow-icon">
