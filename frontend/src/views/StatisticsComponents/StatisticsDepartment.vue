  ...
  <div class="container" :class="{cursorblock: pannelLoading === true}">
    ...
    <div class="contents-box">
      <div class="student-sub-toggle">
        <div class="all dragblock" :class="[this.subToggleButton ? 'all-unclick' :'all-click']" @click="allStudentToggleButton">전체 학과</div>
        <div class="each dragblock" :class="[this.subToggleButton ? 'each-click' :'each-unclick']" @click="eachStudentToggleButton">학과별</div>
      </div>
        ...
        <div v-if="!showTable" class="table">
          <transition name="slide-fade" mode="out-in">
            ...
            <div v-else class="each-table">
              ...
              <div class="sub-table-right">
                <div class="title">학과별 Commits</div>
                <div class="sub-table">
                  <table>
                    <thead class="table-header-wrapper">
                      <th width="203px">학과</th>
              ...
              <!-- 줄 바뀜 -->
              <div class="sub-table-left">
                <div class="title">학과별 Issues</div>
                <div class="sub-table">
                  <table>
                    <thead class="table-header-wrapper">
                      <th width="203px">학과</th>
