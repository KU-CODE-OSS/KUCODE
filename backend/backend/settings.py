...
KOREAUNIV_OPENAPI_TOKEN=env("KOREAUNIV_OPENAPI_TOKEN")
...
# Google Drive configuration for board file uploads
ENABLE_BOARD_DRIVE_UPLOAD = env.bool("ENABLE_BOARD_DRIVE_UPLOAD", default=False)
