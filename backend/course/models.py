...
class Course_registration(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['course_pk','course_id', 'course_year', 'course_semester','student'], name='unique_course_registration')
        ]
...
class Course_project(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['course_pk','course_id', 'course_year', 'course_semester','repo','repo_name'], name='unique_course_project')
        ]
